        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-info text-primary display-4" href="index.php#Sobre">Sobre</a></li>
                    ...
                    <li class="nav-item"><a href="logout.php" class="nav-link link text-info text-primary display-4">Logout</a></li>
    ...
    <div class="align-center container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3"><p>Quantidade de embalagens recicladas: <?php 
                    require_once("conexao.php");

                    $CNPJFabr = $Dados["Cnpj"];

                    $ComandoSQL = "SELECT COUNT(*) as QntEmbalagem FROM smartembalagem Where CnpjFabr = '$CNPJFabr'";
            ...
            <div class="col-12 col-lg-10">
                <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3"><p>Concessão bonificação: Negado</p></h1>
            </div>
        </div>
    </div>
</section>

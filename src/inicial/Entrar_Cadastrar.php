    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form">
                <form action="../login/Login.php" method="POST" class="mbr-form form-with-styler mx-auto">
                    <div class="">
                        <?php
                            ...
                            if(isset($_POST["envioLogin"])):
                                foreach($Erros as $Erro):
                                    echo "<div class='alert alert-danger col-12'><ul>".$Erro."</ul></div>";
                                endforeach;
                            endif;
                        ?>
                    </div>
...
<section class="form7 cid-sd2KXAJI0R" id="form7-t">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form">
                <form action="../cadastro/cadastro.php" method="POST" data-rcpha_sitekey="" data-rcpha_secretkey="" class="mbr-form form-with-styler mx-auto">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form">
                <form action="../cadastro/cadastro.php" method="post" class="mbr-form form-with-styler mx-auto">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 form-group" data-for="">
                        <input type="number" name="tokenValidacaoCadastro" placeholder="Token de validação" data-form-field="" class="form-control" value="" required>
                    </div>
